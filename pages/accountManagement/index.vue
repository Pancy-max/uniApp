<template>
  <view class='account'>
	  ...
	  <!-- </picker> -->
	  <view class="font_image" @click="password">
	  		<view>修改密码</view>
			<image class="icon1" src="../../static/common/btn_01.png" mode=""></image>
	  </view>
	 <!-- <view class="font_image" @click="logOut" v-if="H5Status">
	  		<view>退出登录</view>
	  			<image class="icon1" src="../../static/common/btn_01.png" mode=""></image>
	  </view> -->
	  ...
	  <uni-popup :maskClick='false' ref="popup" type="bottom">
		  <view class="popups">
		  	...
		  	<view class="paishe" @click="selectPic(2)">
		  		从相册选取
		  	</view>
		  ...
		  uni.chooseImage({
			  ...
			  success: function (res){
					...
					uni.uploadFile({
						   ...
						   let	photo = JSON.parse(arr[1].data).data
								that.request({
